...
export default class Editbuku extends React.Component {
    static navigationOptions = {
     ...
     constructor(props) {
         super(props);
         this.state = {
           data_bukuArray:[{'kode_buku': 'kode_buku'}],
           kode_buku: '',
           judul_buku: '',
           jenis_buku: '',
           penulis: '',
     ...
     _edit = () => {
      axios.post('https://putukharisma.000webhostapp.com/sistemperpustakaan/updateDataBuku.php', {
        kode_buku: '',
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <Header judul={"EDIT BUKU PERPUSTAKAAN"} />
      ...
      <ScrollView>
            ...
            <View style={styles.box1}>
              <TouchableHighlight
                ...
                style={styles.tombol}>
                <Text style={styles.tekstombol}>Edit Buku</Text>
              </TouchableHighlight>
            </View>
                </View>
        </ScrollView>
